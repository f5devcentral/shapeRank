...
Let $f$ be a function with signature $f(p_1: S_1 T_1, \ldots, p_n: S_n T_n)$ and let $r_i = rank(S_i), i \in 1..n$. Then

$ \RERANK{}$ $f$  $\TO{}$ $r_1, \ldots, r_n$ evaluates to a function with body $f(a_1, \ldots, a_n)$ and signature 
