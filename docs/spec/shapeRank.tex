...
{\em
Respecify as a syntax for a function? That would make it clear that it maps over streams like everything else.
Problem being that the type system cannot express such a function, so we have to be careful how we phrase  this.
}
