...
An {\em external function signature} lists the names and types of each of the function's parameters in parentheses, followed by a colon followed by the function's return type, and defines a  function type [\ref{functionTypes}] whose domain is cartesian product of the  listed parameter types and whose range is the given return type.
