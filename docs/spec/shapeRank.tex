...
Let $S$ be a scope, let $R$ be the type of the body of $F$ in scope $S <- [p_i = a_i], i = 1..k$, and let $shape_c$ be the concatenation of $shape(common\_frame)$ and $shape(R)$. Then the type of $c$ is $shape_c baseType(R)$.
