...
ShapeRank (e.g., contains()) are defined in a separate prelude specification. They can still be given a specification using ShapeRank code, augmented with prose
